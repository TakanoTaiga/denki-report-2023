...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.9]
        \datavisualization[ 
            ...
            y axis={label={電流[A]},length=6cm,min value=0, max value=500},
        ]
        data[set=index_a] {
            x, y
            0,0
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.9]
        \datavisualization[ 
            scientific axes,
            visualize as line/.list={index_a, index_b}, 
            index_a={style={thick,mark=*,black},label in legend={text=aのインデックス}},
            index_b={style={thick,dashed,mark=triangle,black},label in legend={text=bのインデックス}},
            legend={north west outside},
            x axis={label={x軸ラベル},length=10cm},
            y axis={label={y軸ラベル},length=6cm},
        ]
        data[set=index_a] {
            x, y
            0,0
